...
data1 <- data %>%
  ...
  summarise(Temp_mean_vals = mean(Temp_in,na.rm = TRUE))
#> Error in mean(Temp_in): object 'Temp_in' not found
  
data1
#> # A tibble: 0 x 15
#> # ... with 15 variables: Waypoint <int>, Zone <chr>, Lat <dbl>, Long <dbl>,
#> #   Site <chr>, Season <chr>, Tide_time <chr>, Temp_in <dbl>, Salinity <dbl>,
#> #   Phosphate <dbl>, Silicate <dbl>, NN <dbl>, pH <dbl>, TA <dbl>,
#> #   percent_sgd <dbl>
```
